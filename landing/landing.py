...
.before-after::after {
  ...
  height: 220px;
  border-radius: 999px;
  background: radial-gradient(circle, rgba(122, 112, 255, 0.28) 0%, rgba(122, 112, 255, 0.08) 45%, transparent 72%);
  filter: blur(28px);
  pointer-events: none;
}
  ...
  <div class="container">
    ...
    <div class="before-after-grid">
      <div class="before-card">
        <img src="static/before-after-before.jpg" alt="Before image">
      </div>

      <div class="before-card">
        <img src="static/before-after-after.jpg" alt="After image">
      </div>
    </div>
  </div>
</section>
          ...
          <div class="container">
            ...
            <div class="pricing-grid">
              <article class="plan-card plan-light">
                ...
                <button class="plan-btn" onclick="window.location.href='http://176.104.50.7/'">Try for free</button>
